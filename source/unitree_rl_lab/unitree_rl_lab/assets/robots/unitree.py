...
# Specify either of the following sources for the robot models
# when UNITREE_ROS_DIR is set URDF files will be used and when UNITREE_MODEL_DIR is set USD files will be used
UNITREE_ROS_DIR = ""  # Replace with the actual path to your unitree_ros package
UNITREE_MODEL_DIR = ""  # Replace with the actual path to your unitree_model directory
